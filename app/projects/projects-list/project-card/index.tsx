    ...
    <div className="rounded-lg h-[436px] flex flex-col bg-gray-800 overflow-hidden border-2 border-gray-800 hover:border-emerald-400 opacity-70 hover:opacity-100 transition-all group">
      ...
      <div className="flex-1 flex flex-col p-8">
        ...
        <p className="mt-2 text-gray-400 line-clamp-4">
          ...
          fugit cum non sit consequuntur corrupti tempore, beatae expedita animi
          modi magni voluptatum consectetur. Enim consectetur fugit sed error
          nulla mollitia earum ratione est optio minus.
        </p>
